...
w.dir <- args[1] # w.dir <- "/omics/groups/OE0540/internal/projects/przybilm/medulloblastoma/revision/scrna_analysis/infercnv_MB/GTseq"
setwd(w.dir)
...
infercnv_obj = infercnv::run(infercnv_obj,
                             cutoff= 1.25, # use 1 for smart-seq, 0.1 for 10x-genomics
