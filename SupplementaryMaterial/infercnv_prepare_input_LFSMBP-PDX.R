...
## LFSMBP-NUCLEI
c.dir <- "/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/LFSMBP/LFSMBP-PDX/outs/"
...
# cell.clusters <- read.csv("/icgc/dkfzlsdf/analysis/B260/projects/przybilm/medulloblastoma/scRNA_analysis/scanpy/LFSMBP-Nuclei_metadata.csv")
# 
# # get endothelial cells
# cell.clusters_WT <- as.character(cell.clusters[grep("endothelial cells", cell.clusters$new_clusters), "X"])
# cell.clusters_WT <- str_split_fixed(cell.clusters_WT , "-1", 2)[,1]

# read in the mouse cells
mouse.cells <- read.table('/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/LFSMBP/mm10_and_hg19/sample3.mapping.counts.txt', 
...
# read in genes x cells matrix from 10x genomics for LFSMBP-PDX with microglia reference
# matrix.tmp.neg <- Read10X(paste0("/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/LFSMBP/LFSMBP-PDX/outs/filtered_feature_bc_matrix"))
...
# read in the barcodes for the normal cells if using a reference
cell.clusters <- read.csv("/icgc/dkfzlsdf/analysis/B260/projects/przybilm/medulloblastoma/scRNA_analysis/scanpy/LFSMBP-PDX_metadata.csv")
