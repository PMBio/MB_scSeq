...
## ST1R-NUCLEI
c.dir <- "/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/ST1R/ST1R-PDX/outs/"
...
mouse.cells <- read.table('/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/ST1R/mm10_and_hg19/sample4.mapping.counts.txt', 
...
# read in the barcodes for the normal cells if using a reference
cell.clusters <- read.csv("/icgc/dkfzlsdf/analysis/B260/projects/przybilm/medulloblastoma/scRNA_analysis/scanpy/ST1R-PDX_metadata.csv")
