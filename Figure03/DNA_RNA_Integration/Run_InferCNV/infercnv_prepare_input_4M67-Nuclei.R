...
list.of.packages <- c("Matrix", "tidyverse", "stringr", "biomaRt", "httr")
...
## STP-NUCLEI
c.dir <- "/icgc/dkfzlsdf/analysis/B260/projects/chromothripsis_medulloblastoma/data/10XRNA5P/4M67/4M67-Nuclei/outs/"
...
cell.clusters <- read.csv("/icgc/dkfzlsdf/analysis/B260/projects/przybilm/medulloblastoma/scRNA_analysis/scanpy/4M67-Nuclei_metadata.csv")
...
cell.clusters_malignant <- as.character(cell.clusters[grep("malignant|neurons", cell.clusters$new_clusters), "X"])
