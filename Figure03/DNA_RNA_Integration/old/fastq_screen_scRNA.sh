#!/bin/sh
# LSF directivesy
#BSUB -J fastq_screen_gtRNA"
#BSUB -e fastq_screen_gtRNA-%J.err                 # error file path, where % will be replaced with job ID
#BSUB -o fastq_screen_gtRNA-%J.out                 # outut file path, where % will be replaced with job ID
...
OUTPUT_PATH='/omics/groups/OE0540/internal/projects/przybilm/medulloblastoma/revision/gt_seq/scRNA_384/fastq_screen'
mkdir $OUTPUT_PATH
...
do
    ...
    fastq_screen --threads 8 --aligner 'bwa' --conf $CONFIG --outdir $OUTPUT_PATH $READ1   
